...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 2829483529174678381),
      name: 'Address',
      lastPropertyId: const IdUid(4, 5065302989301081384),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5286842153609992968),
            name: 'street',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(2, 393656405927802712),
            name: 'number',
            type: 6,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2230714152418930766),
            name: 'complement',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 5065302989301081384),
            name: 'id',
            type: 6,
            flags: 1)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 2829483529174678381),
...
class Address_ {
  ...
  /// see [Address.id]
  static final id = QueryIntegerProperty<Address>(_entities[0].properties[3]);
}
